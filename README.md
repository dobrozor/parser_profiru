...
## ОБНОВЛЕНИЕ 2.3
Добавил настройку по времени, а так же обновли немного код (профи ру пытается максимально убрать возможность парсинга). Но всё работает стабильно + появилось больше логов, чтоб видеть ошибки (если они есть). Исполняемый файл "Приложение.py" остальные я запросил
