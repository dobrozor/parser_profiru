...
### Настройка
TELEGRAM_TOKEN - это токен который мы берем в телеграмм у @BotFather при создании нашего бота
CHAT_ID - это ваш ID в телеграмм, можно получать у @Get_myidrobot в телеграмм
Логин профи.ру - берется из анкеты в настройках (имеет вид IvanovAP)
Пароль профи.ру - ваш пароль от сервиса
Стоп-слова - это слова которые вы сможебе заблокировать, если они есть в заголовке или основном тексте заказа
