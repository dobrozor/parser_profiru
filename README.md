...
Данный пункт только для разработчиков. Скачиваете архив. Я использовал для создания pyinstaller. В командной строке используем *pyinstaller app.spec* и всё, приложение готово
